...
- Плитки – прокручиваемый список карточек (см. также «[Плитки и плиточное главное меню](../GeneralFunctionsOfThePlatform/Tiles)»)
...
- Современное поле ввода - настраиваемое поле ввода (см. «[Современное поле ввода](../GeneralFunctionsOfThePlatform/ModernEditText)»)
